...
Options:\n\
  -a, --algo=ALGO       specify the hash algorithm to use\n\
			verus      The Verus Algo -big surprise-\n\
...
int main(int argc, char *argv[])
{
	...
	printf("*************************************************************\n");	
	printf("*  CPU Miner for Verushash v2.2 v3.8.3a based on ccminer   *\n");
	printf("*************************************************************\n");	

		printf("Rewritten to work on 32bit ARM devices\n");
		printf("Made by Ordnungspolizei / Fallen Angel\n");
	    printf("Made in Germany - Deutsche Qualitaet\n");
		printf("This miner is just a PoC!\n");
